...
def add_urls_to_keyword_analysis():
    keyword_df = pd.read_csv('./datasets/keyword_analysis.csv')
    ...
    new_df = pd.merge(keyword_df, ipo_df[['symbol', 'public_price_per_share', 'price_public_total', 'url', 'ipo_date']], how='left', on=['symbol', 'price_public_total' ])
